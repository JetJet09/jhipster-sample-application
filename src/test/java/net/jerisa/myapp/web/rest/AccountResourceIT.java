package net.jerisa.myapp.web.rest;

import static net.jerisa.myapp.web.rest.AccountResourceIT.TEST_USER_LOGIN;
...
import net.jerisa.myapp.config.Constants;
import net.jerisa.myapp.domain.User;
import net.jerisa.myapp.repository.AuthorityRepository;
import net.jerisa.myapp.repository.UserRepository;
import net.jerisa.myapp.security.AuthoritiesConstants;
import net.jerisa.myapp.service.UserService;
import net.jerisa.myapp.service.dto.AdminUserDTO;
import net.jerisa.myapp.service.dto.PasswordChangeDTO;
import net.jerisa.myapp.service.dto.UserDTO;
import net.jerisa.myapp.web.rest.vm.KeyAndPasswordVM;
import net.jerisa.myapp.web.rest.vm.ManagedUserVM;
